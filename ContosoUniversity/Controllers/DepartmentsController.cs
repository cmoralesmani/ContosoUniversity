...
namespace ContosoUniversity.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int? id, uint concurrencyStamp)
        {
            if (id == null)
            {
                return NotFound();
            ...
            _context.Entry(departmentToUpdate).Property("ConcurrencyStamp").OriginalValue = concurrencyStamp;
                ...
                s => s.Name, s => s.StartDate, s => s.Budget, s => s.InstructorID))
            {
                ...
                catch (DbUpdateConcurrencyException ex)
                {
                    ...
                    else
                    {
                        ...
                        departmentToUpdate.ConcurrencyStamp = (uint)databaseValues.ConcurrencyStamp;
